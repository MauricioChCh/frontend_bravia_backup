...
fun BusinessHomeScreen (
    ...
    LaunchedEffect(Unit) {
        businessViewModel.findAllBusinessOwnerIntership(1) // Cambia el ID según sea necesario
                    ...
                    content = { internship ->
                        InternshipCard(
                            ...
                            onBookmarkChange = { isBookmarked ->
                                businessViewModel.bookmarkInternship(internship.id, isBookmarked)
                            },
                            onClick = {
                                // TODO: Navigate to business internship details
                            }
                        )
