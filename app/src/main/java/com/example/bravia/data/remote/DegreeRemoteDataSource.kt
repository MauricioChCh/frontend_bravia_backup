...
class DegreeRemoteDataSource @Inject constructor(
    private val signUpService: SignUpService
) {
    /**
     * Retrieves a list of all available degrees from the remote API.
     *
     * @return [Result] containing a list of [DegreeDTO] objects if successful
     * or an exception if the operation failed
     */
    suspend fun getAllDegrees(): Result<List<DegreeDTO>> = safeApiCall {
        signUpService.getAllDegrees()
    }
