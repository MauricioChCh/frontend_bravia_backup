...
/**
 * Custom JSON deserializer for [BusinessAreaDTO] objects.
 *
 ...
 */
class BusinessAreaDeserializer : JsonDeserializer<BusinessAreaDTO>{

    /**
     * Deserializes a JSON element into a [BusinessAreaDTO] object.
     *
     * @param json The JSON element to deserialize.
     * @param typeOfT The type of the object to deserialize into.
     * @param context The deserialization context.
     * @return The deserialized BusinessAreaDTO object.
    ...
    override fun deserialize(
        ...
        return BusinessAreaDTO(id, name)
    }
}