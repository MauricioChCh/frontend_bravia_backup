...
class BusinessAreaRemoteDataSource @Inject constructor (
    private val signUpService: SignUpService
) {

    /**
     * Retrieves a list of all available business areas from the remote API.
     *
     * @return [Result] containing a list of [BusinessAreaDTO] objects if successful
     * or an exception if the operation failed
     */
    suspend fun getAllBusinessAreas(): Result<List<BusinessAreaDTO>> = safeApiCall {
        signUpService.getAllBusinessAreas()
    }
